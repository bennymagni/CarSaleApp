        ...
        <div className='testimonial'>
            ...
            <section className='testimonycontainer'>
                <section className='testimony'>
                    <img src={img1} alt="" width='135' height='90' className='testimonialImage'/>
                ...
                <section className='testimony testimony2'>
                    <img src={img2} alt="" width='135' height='90' className='testimonialImage'/>
                ...
                <section className='testimony testimony3'>
                    <img src={img3} alt="" width='135' height='90' className='testimonialImage'/>
